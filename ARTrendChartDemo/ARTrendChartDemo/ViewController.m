...
- (void)viewDidAppear:(BOOL)animated {
	...
	[chart setBackgroundColor:[UIColor colorWithRed:0.3568 green:0.5137 blue:0.8 alpha:1] trendAreaColor:[UIColor colorWithRed:0.4824 green:0.6118 blue:0.8392 alpha:1] trendLineColor:[UIColor whiteColor] selectColor:[UIColor colorWithRed:0.3568 green:0.5137 blue:0.8 alpha:1]];
