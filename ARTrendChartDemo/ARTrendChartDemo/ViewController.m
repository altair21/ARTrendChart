...
@property (weak, nonatomic) IBOutlet ARTrendChart *chartIB;
...
- (void)viewDidLoad {
	...
	[_chartIB setBackgroundColor:[UIColor colorWithRed:0.3568 green:0.5137 blue:0.8 alpha:1] trendAreaColor:[UIColor colorWithRed:0.4824 green:0.6118 blue:0.8392 alpha:1] trendLineColor:[UIColor whiteColor] selectColor:[UIColor colorWithRed:0.3568 green:0.5137 blue:0.8 alpha:1]];
	[_chartIB setYAxisItem:@[@70.0, @90.0, @110.0, @130.0] yAxisItemSummary:@"血压 mm.HG" yAxisTextFontSize:14.0 yAxisTextColor:[UIColor whiteColor]];
	[_chartIB setXAxisItem:@[@"06/01", @"06/02", @"06/03", @"06/04", @"06/05", @"06/06", @"06/07", @"06/08", @"06/09"] xAxisItemSummary:nil xAxisTextFontSize:14.0 xAxisTextColor:[UIColor colorWithRed:0.6 green:0.6 blue:0.6 alpha:1]];
	[_chartIB setData:@[@73.0, @85, @88.5, @81.3, @115.2, @94.3, @122.8, @130.2, @145.5]];
	[self.view addSubview:_chartIB];
}
